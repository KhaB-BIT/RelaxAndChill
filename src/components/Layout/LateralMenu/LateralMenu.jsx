        ...
        <div>
            ...
            <div className="absolute right-[20px] top-[30%] flex flex-col items-center justify-center rounded-full bg-[rgba(0,0,0,0.6)] h-[280px] w-[70px]">
                <div className="w-[100px] h-[70px] flex justify-center items-center relative cursor-pointer ">
                    <button
                        className={`w-[70px] h-[70px] bg-transparent outline-none overflow-hidden transition-all duration-150 ease-in-out z-20  ${
                            mood ? "opacity-100" : "opacity-20 brightness-200"
                        }`}
                        onClick={handleMood}
                    >
                        <img
                    ...
                    <div
                        className={`-scale-y-100 absolute top-[-23px] right-[10px] h-[120px] w-[80px] z-10 ${
                            mood ? "" : "hidden"
                        }`}
                    >
                        <img
                            className=""
                            src="./assets/img/menu/lateral_bottom.svg"
                            alt="lateraltop"
                        />
                    </div>
                ...
                <div className="w-[100px] h-[70px] flex justify-center items-center relative cursor-pointer">
                    <button
                        className={`w-[70px] h-[70px] outline-none z-10 overflow-hidden transition-all duration-150 ease-in-out  ${
                            playlist
                                ? "opacity-100 bg-[#070707]"
                                : "opacity-20 brightness-200 bg-transparent"
                        }`}
                ...
                <div className="w-[100px] h-[70px] flex justify-center items-center relative cursor-pointer">
                    <button
                        className={`w-[70px] h-[70px] z-20 bg-transparent outline-none overflow-hidden ${
                            product
                                ? "opacity-100"
                    ...
                    <div
                        className={` absolute top-[-26px] right-[10px] h-[120px] w-[80px] z-10 ${
                            product ? "" : "hidden"
                        }`}
                    >
                        <img
            ...
            {/* Mood */}
            <div
                className={`absolute top-[17%] right-[90px] w-[345px] rounded-[24px] z-10 overflow-hidden bg-[#070707] ${
                    mood ? "" : "hidden"
                }`}
            >
                <div className="mx-[32px] py-[10px]">
                    ...
                    <div className="flex justify-center items-center gap-[12px] my-[16px]">
                        ...
                        >
                            <div
                                className={`absolute top-[-14%] left-2 bg-transparent ${
                                    clickSleep
                                        ? ""
                                        : "opacity-10 brightness-200"
                                }`}
                            >
                                <img
                                    className="scale-[1.8]"
                            ...
                            <p
                                className={`absolute bottom-[10px] text-[#fff] text-[16px] ${
                                    clickSleep ? "opacity-100" : "opacity-30"
                                }`}
                            >
                                Sleepy
                            </p>
                        ...
                        >
                            ...
                            <p
                                className={`absolute bottom-[10px] text-[#fff] text-[16px] ${
                                    clickJazzy ? "opacity-100" : "opacity-30"
                                }`}
                            >
                                Jazzy
                            </p>
                        ...
                        >
                            ...
                            <p
                                className={`absolute bottom-[10px] text-[#fff] text-[16px] ${
                                    clickChill ? "opacity-100" : "opacity-30"
                                }`}
                            >
                                Chill
                            </p>
                    ...
                    <div>
                        <div className="flex items-center justify-between py-[8px]">
                            <p className="text-[14px] text-white opacity-40">
                                City traffic
                            </p>
                            <div>
                                <ReactAudioPlayer
                ...
                <div className="mx-[16px] py-[10px]">
                    ...
                    <div>
                        <p className="opacity-50 text-[14px] text-white">
                            You haven't saved any template yet, open the mixer
                            to save one.
                        </p>
                    </div>
                </div>
            ...
            >
                <div className="change-set m-[16px] max-h-[600px] rounded-[16px] overflow-y-auto">
                    ...
                    <div className="mb-[16px] cursor-pointer bg-[#0005]">
                        <img
                            className="h-[190px] object-cover w-[100%] rounded-[16px] aspect-video"
                            src="./assets/img/changeset/bookcafe.png"
                            alt="bookcafe"
                        />
                    </div>
                    <div className="my-[16px] cursor-pointer bg-[#0005] relative">
                        ...
                        <img
                            className="h-[190px] object-cover w-[100%] rounded-[16px] aspect-video opacity-50"
                            src="./assets/img/changeset/dreamin.png"
                            alt="dreamin"
                        />
                    </div>
                    <div className="my-[16px] cursor-pointer bg-[#0005] relative">
                    ...
                    <div className="my-[16px] cursor-pointer bg-[#0005] relative">
                        ...
                        <img
                            className="h-[190px] object-cover w-[100%] rounded-[16px] aspect-video opacity-50"
                            src="./assets/img/changeset/cottage.png"
                            alt="cottage"
                        />
                    </div>
                    <div className="my-[16px] cursor-pointer bg-[#0005] relative">
                        ...
                        <img
                            className="h-[190px] object-cover w-[100%] rounded-[16px] aspect-video opacity-50"
                            src="./assets/img/changeset/kyoto.png"
                            alt="kyoto"
                        />
                    </div>
            ...
            {/* Productivity */}
            <div
                className={`absolute top-[42%] right-[90px] w-[300px] rounded-[24px] z-10 overflow-hidden bg-[#070707] ${
                    product ? "" : "hidden"
                }`}
            >
                <div className="mx-[16px] py-[10px]">
                    ...
                    <div className="relative">
                        ...
                        <div>
                            <div className="bg-[hsla(0,0%,100%,.05)] flex items-center rounded-[13px] cursor-pointer flex-row mb-[12px] py-[8px] pl-[16px] pr-[8px]">
                                <img
                                    className="brightness-[9] opacity-20 w-[28px] h-[28px]"
                                    src="./assets/img/product/tomato.svg"
                                    alt="tomato"
                                />
                                <h6 className="text-[16px] font-[500] leading-[16px] mx-[16px] text-white flex-1">
                                    Timer and Tasks
                        ...
                        <div>
                            <div className="bg-[hsla(0,0%,100%,.05)] flex items-center rounded-[13px] cursor-pointer flex-row mb-[12px] py-[8px] pl-[16px] pr-[8px]">
                                <img
                                    className="brightness-[9] opacity-20 w-[28px] h-[28px]"
                                    src="./assets/img/product/notes.svg"
                                    alt="notes"
                                />
                                <h6 className="text-[16px] font-[500] leading-[16px] mx-[16px] text-white flex-1">
                                    Notes
                        ...
                        <div>
                            <div className="bg-[hsla(0,0%,100%,.05)] flex items-center rounded-[13px] cursor-pointer flex-row mb-[12px] py-[8px] pl-[16px] pr-[8px]">
                                <img
                                    className="brightness-[9] opacity-20 w-[28px] h-[28px]"
                                    src="./assets/img/product/history.svg"
                                    alt="history"
                                />
                                <h6 className="text-[16px] font-[500] leading-[16px] mx-[16px] text-white flex-1">
                                    History
